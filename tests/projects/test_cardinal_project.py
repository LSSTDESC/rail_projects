...
def test_project_class(setup_project_area: int) -> None:
    ...
    project = RailProject.load_config("tests/ci_cardinal_project.yaml")
    ...
    check_path = "tests/temp_data/data/ci_test_v1.1.3/58/cardinal_test-0.parquet"
    assert check_path in catalog_files_truth

    catalog_files_reduced = project.get_catalog_files("reduced", selection="gold")
    check_path = "tests/temp_data/data/ci_test_v1.1.3/ci_test_gold/58/cardinal_test_file-0.pq"
    ...
    check_path = "tests/temp_data/data/ci_test_v1.1.3/ci_test_gold_baseline/58/output.hdf5"
    ...
    project.subsample_data(
        ...
        file_template="train_100",
        subsampler_class_name="random_subsampler",
        subsample_name="train_100",
        flavor="baseline",
        selection="gold",
    )
