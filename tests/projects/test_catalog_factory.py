...
from rail.projects.catalog_template import RailProjectCatalogInstance, RailProjectCatalogTemplate
...
def test_load_yaml(setup_project_area: int) -> None:
    ...
    assert isinstance(the_catalog_instances["degraded_ci_test_1.1.3_gold_blend"], RailProjectCatalogInstance)
    ...
    the_catalog_instance = RailCatalogFactory.get_catalog_instance("degraded_ci_test_1.1.3_gold_blend")
